...
import com.project.eventxperience.model.SportEvent; // Adicionado
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        user1.setRoles(Arrays.asList(roleUser, roleOrganizer));
        ...
        // Obtenha o usuário organizador autenticado
        User organizer = userRepository.findByUsername("carol");


        // Criar evento esportivo

        SportEvent sportEvent = new SportEvent();
        sportEvent.setName("Final de Futebol");
        sportEvent.setDescription("Final emocionante de futebol entre os melhores times do campeonato.");
        sportEvent.setEventDate(new Date());
        sportEvent.setSport(sport1);
        sportEvent.setTicketQuantity(100);
        sportEvent.setTicketPrice(50.0f);
        sportEvent.setCreator(organizer);
